...
if (!existe) {
 ...
 await db.run(
   `
   INSERT INTO proveedores (RazonSocial, CUIT)
       VALUES 
       ('YPF Sociedad Anónima', 20123456789),
       ('Banco de la Nación Argentina', 30123456780),
       ('Arcor S.A.I.C.', 40123456781),
       ('MercadoLibre, Inc.', 50123456782),
       ('Telecom Argentina S.A.', 60123456783),
       ('Techint Compagnia Tecnica Internazionale S.p.A.', 70123456784),
       ('Grupo Clarín S.A.', 80123456785),
       ('Banco Santander Río S.A.', 90123456786),
       ('Globant S.A.', 10123456787),
       ('IRSA Propiedades Comerciales S.A.', 11123456788),
       ('Despegar.com, Corp.', 12123456789),
       ('Grupo Financiero Galicia S.A.', 13123456780),
       ('Siderar S.A.I.C.', 14123456781),
       ('Grupo Supervielle S.A.', 15123456782),
       ('Telecom Personal S.A.', 16123456783),
       ('Grupo Los Grobo S.G.R.', 17123456784),
       ('Grupo Roggio S.A.', 18123456785),
       ('Distribuidora de Gas Cuyana S.A.', 19123456786)
    ;`
 );
}
